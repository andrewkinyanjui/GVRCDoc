...
export class TreatmentCategoryPostPage {
  ...
  health360ItemNews: Array<BlogPostInterface> = [{
    id: 1, img: 'assets/imgs/sample_1.jpg', title: "Gender-based violence | The Role of the NPS in GBV?",
    smallDescription: "The NATIONAL POLICE SERVICE are equipped to manage any gender-based violence cases that are reported. " +
    "with the utmost respect and confidentiality Call 112 999 or 911 anytime to report any suspected." +"Together we can end GBV!",
   
    publishedDate: "27 Jan 2021 11.25am",
    descriptionHTML: htmlDemoText,
    postType: PostType.VIDEO_POST,
      videoURL: "https://www.youtube.com/watch?v=_vSsJs6nWoI"
  },
    {
